...
| :--- | :--- | :--- | :--- |
| *C01* | *AkunPengguna* | *Menyimpan data akun & identitas pengguna (Pemilik F&B, Perwakilan NGO, Admin Sistem).* | *UC01, UC02, UC03, UC06, UC07, UC08, UC09, UC10, UC11, UC12* |
| *C02* | *Pendaftaran* | *Menyimpan data registrasi & status verifikasi.*| *UC01, UC02, UC03*|
| *C03* | *DokumenPendukung* | *Menyimpan dokumen yang diunggah pendaftar.*| *UC01, UC02*|
| *C04* | *VerifikasiController* | *Menangani proses pemeriksaan & keputusan verifikasi oleh Admin.*| *UC02*|
| *C05* | *Produk*| *Menyimpan jenis produk milik Pemilik F&B.*| *UC04, UC05, UC06*|
| *C06* | *DataPenjualan* | *Menyimpan data penjualan & sisa produk harian.*| *UC04, UC05*|
| *C07* | *PrediksiProduksi* | *Menyimpan hasil prediksi produksi.*| *UC05*|
| *C08* | *ProdukSurplus* | *Menyimpan produk surplus: jumlah, batas waktu, status.*| *UC06, UC07, UC08, UC09, UC10, UC11*|
| *C09* | *MetodeDistribusiSurplus* | *Menyimpan pilihan distribusi surplus (donasi/jual) beserta harga.*| *UC07, UC08, UC09*|
| *C10* | *DokumenKlaim* | *Mencatat NGO yang mengklaim produk surplus & waktu klaim.*| *UC10, UC11*|
| *C11* | *LogAktivitas* | *Mencatat pengguna, aktivitas, dan waktu.*| *UC12*|
| *C12* | *RegistrasiPage* | *Antarmuka formulir registrasi akun.*| *UC01*|
| *C13* | *VerifikasiPage* | *Antarmuka daftar & detail pendaftar untuk Admin.*| *UC02*|
| *C14* | *StatusPendaftaranPage* | *Antarmuka status pendaftaran.*| *UC03*|
| *C15* | *PenjualanPage* | *Antarmuka formulir input data penjualan harian.*| *UC04*|
| *C16* | *PrediksiPage* | *Antarmuka dashboard hasil prediksi produksi.*| *UC05*|
| *C17* | *ProdukSurplusPage* | *Antarmuka input produk surplus.*| *UC06*|
| *C18* | *DistribusiSurplusPage* | *Antarmuka pengaturan metode distribusi surplus.*| *UC07*|
| *C19* | *DaftarSurplusPage* | *Antarmuka daftar & pencarian/penyaringan produk surplus untuk NGO.*| *UC08, UC09*|
| *C20* | *KlaimPage* | *Antarmuka pengajuan klaim produk surplus.*| *UC10*|
| *C21* | *PengambilanPage* | *Antarmuka konfirmasi pengambilan produk.*| *UC11*|
| *C22* | *LogAktivitasPage* | *Antarmuka dashboard log aktivitas Admin.*| *UC12*|
| *C23* | *AuthController* | *Menangani registrasi akun & pengecekan status pendaftaran.*| *UC01, UC03*|
| *C24* | *PenjualanController* | *Memvalidasi & menyimpan data penjualan harian.*| *UC04*|
| *C25* | *PrediksiController* | *Mengecek syarat data historis & menjalankan algoritma prediksi.*| *UC05*|
| *C26* | *ProdukSurplusController* | *Memvalidasi & menyimpan data surplus serta metode distribusi.*| *UC06, UC07*|
| *C27* | *SurplusController* | *Mengurutkan berdasarkan jarak & menyaring/mencari produk surplus.*| *UC08, UC09*|
| *C28* | *KlaimController* | *Memvalidasi ketersediaan, menyetujui klaim, & konfirmasi pengambilan.*| *UC10, UC11*|
| *C29* | *LogController* | *Menampilkan & menyaring log aktivitas.*| *UC12*|
...
<p align="center">
<img alt="Class Diagram UC02" src="./assets/diagram/Class Diagram-UC02.jpg" width="48%">
</p>
<p align="center">
...
<p align="center">
<img alt="Class Diagram UC03" src="./assets/diagram/Class Diagram-UC03.jpg" height="550px" width="auto">
</p>
<p align="center">
...
<p align="center">
<img alt="Class Diagram UC12" src="./assets/diagram/Class Diagram-UC12.jpg" height="550px" width="auto">
</p>
<p align="center">
