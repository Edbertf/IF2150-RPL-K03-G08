...
<p align="center">
<img alt="Class Diagram UC01" src="./assets/diagram/Class Diagram-UC01.jpg" width="70%">
</p>
<p align="center">
...
| *C02* | *Pendaftaran* | *Menyimpan data registrasi beserta status verifikasi ("menunggu verifikasi", "diterima", "ditolak").* |
| *C03* | *DokumenPendukung* | *Menyimpan dan merepresentasikan dokumen yang diunggah oleh pendaftar untuk keperluan verifikasi akun.* |
| *C03* | *DokumenVerifikasi* | *Menangani proses pemeriksaan dan penentuan hasil verifikasi pendaftaran oleh Admin Sistem.* |

#### Diagram Kelas

<p align="center">
<img alt="Class Diagram UC02" src="./assets/diagram/Class Diagram-UC02.jpg" width="70%">
</p>
<p align="center">
...
<p align="center">
<img alt="Class Diagram UC03" src="./assets/diagram/Class Diagram-UC03.jpg" width="70%">
</p>
<p align="center">
<i>Gambar 2. Diagram Kelas Use Case UC03</i>
</p>
<br>
...
| :--- | :--- | :--- |
| *C01* | *AkunPengguna* | *Menyimpan data akun dan identitas pengguna FoodLink serta informasi mengenai tipe pengguna, yaitu Pemilik F&B, Perwakilan NGO, atau Admin Sistem.* |
| *C02* | *Produk* | *Menyimpan jenis produk milik Pemilik F&B (nama, kategori makanan/minuman).* |
| *C02* | *DataPenjualan* | *Menyimpan jumlah terjual dan jumlah tersisa per produk per tanggal sebagai data historis.* |

#### Diagram Kelas

<p align="center">
<img alt="Class Diagram UC04" src="./assets/diagram/Class Diagram-UC04.jpg" width="70%">
</p>
<p align="center">
...
| *C02* | *Produk* | *Menyimpan jenis produk milik Pemilik F&B (nama, kategori makanan/minuman).* |
| *C02* | *DataPenjualan* | *Menyimpan jumlah terjual dan jumlah tersisa per produk per tanggal sebagai data historis.* |
| *C02* | *PrediksiProduksi* | *Menyimpan dan menghasilkan hasil prediksi jumlah produksi berdasarkan data penjualan historis yang telah tersedia minimal tujuh hari.* |

#### Diagram Kelas

<p align="center">
<img alt="Class Diagram UC05" src="./assets/diagram/Class Diagram-UC05.jpg" width="70%">
</p>
<p align="center">
...
| *C01* | *AkunPengguna* | *Menyimpan data akun dan identitas pengguna FoodLink serta informasi mengenai tipe pengguna, yaitu Pemilik F&B, Perwakilan NGO, atau Admin Sistem.* |
| *C02* | *Produk* | *Menyimpan jenis produk milik Pemilik F&B (nama, kategori makanan/minuman).* |
| *C02* | *ProdukSurplus* | *Menyimpan produk yang ditetapkan surplus: jumlah, batas waktu pengambilan, dan status (tersedia/dikirim).* |

#### Diagram Kelas

<p align="center">
<img alt="Class Diagram UC06" src="./assets/diagram/Class Diagram-UC06.jpg" width="70%">
</p>
<p align="center">
