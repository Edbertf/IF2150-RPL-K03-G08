...
| :--- | :--- | :--- | :--- |
| *KNF01* | *R04* | *Security* | *Sistem harus mengenkripsi seluruh data pribadi pengguna, baik yang tersimpan dalam database maupun yang dikirim melalui jaringan* |
| *KNF02* | *R12* | *Performance* | *Ketika Pemilik F&B meminta hasil prediksi produksi harian, maka sistem harus menampilkan hasil prediksi dalam waktu kurang dari 3 detik* |
| *KNF03* | *R19* | *Reliability* | *Ketika terdapat produk surplus baru yang dipublikasikan, maka sistem harus mengirim notifikasi kepada seluruh NGO terdaftar di sekitar lokasi dengan tingkat keberhasilan pengiriman minimal 99%* |
