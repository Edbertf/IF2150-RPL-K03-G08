...
| :--- | :--- | :--- |
| KF01 | R01 | Event-driven | Ketika pengguna membuka halaman registrasi, sistem harus menampilkan formulir dengan pilihan tipe akun Pemilik F&B atau Perwakilan NGO. |
| KF02 | R01 | State-driven | Selama pengguna mengisi formulir registrasi, sistem harus menyediakan fasilitas unggah dokumen identitas dan dokumen pendukung berupa izin usaha atau surat keterangan organisasi dalam format PDF, JPG, atau PNG. |
| KF03 | R01 | Event-driven | Ketika pengguna mengirimkan formulir registrasi, sistem harus memeriksa kelengkapan seluruh kolom wajib sebelum mengirimkan data ke server. |
| KF04 | R04 | Ubiquitous | Sistem harus mengenkripsi data pribadi pengguna yang disimpan dalam database menggunakan algoritma AES-256. |
| KF05 | R04 | Ubiquitous | Sistem harus menggunakan HTTPS dengan TLS untuk mengenkripsi seluruh pertukaran data antara client dan server. |
| KF06 | R05 | State-driven | Selama terdapat pendaftaran berstatus "menunggu verifikasi", sistem harus menampilkan pendaftaran tersebut dalam daftar verifikasi admin. |
| KF07 | R05 | Event-driven | Ketika admin menyetujui atau menolak pendaftaran, sistem harus memperbarui status pendaftaran sesuai keputusan admin. |
| KF08 | R07 | Event-driven | Ketika admin membuka detail pendaftaran, sistem harus menampilkan data pendaftar beserta dokumen identitas dan dokumen pendukungnya. |
| KF09 | R08 | Event-driven | Ketika status pendaftaran berubah menjadi "diterima" atau "ditolak", sistem harus mengirimkan notifikasi hasil verifikasi kepada pendaftar. |
| KF10 | R09 | Ubiquitous | Sistem harus menyediakan formulir pencatatan penjualan harian yang memuat jumlah produk terjual dan jumlah produk tersisa untuk setiap jenis produk. |
| KF11 | R09 | Unwanted behavior | Bila jumlah produk terjual atau tersisa diisi dengan nilai selain angka non-negatif, maka sistem harus menolak isian tersebut dan menampilkan pesan kesalahan. |
| KF12 | R11 | Event-driven | Ketika Pemilik F&B mengirimkan data penjualan harian yang valid, sistem harus menyimpan data tersebut beserta keterkaitannya dengan produk, tanggal penjualan, dan akun Pemilik F&B. |
| KF13 | R12 | Complex (State-driven + Event-driven) | Selama data penjualan untuk minimal tujuh hari terakhir tersedia, ketika Pemilik F&B membuka dashboard, sistem harus menjalankan prediksi produksi berdasarkan data tersebut. |
| KF14 | R12 | Event-driven | Ketika proses prediksi produksi selesai, sistem harus menyimpan hasil prediksi ke database. |
| KF15 | R13 | State-driven | Selama hasil prediksi produksi tersedia, sistem harus menampilkan hasil tersebut pada dashboard Pemilik F&B dalam bentuk tabel atau grafik. |
| KF16 | R15 | Event-driven | Ketika Pemilik F&B menetapkan produk sebagai surplus, sistem harus mencatat jumlah produk surplus dan batas waktu pengambilannya. |
| KF17 | R16 | State-driven | Selama Pemilik F&B mengatur distribusi produk surplus, sistem harus menyediakan pilihan donasi atau penjualan dengan harga diskon, serta kolom harga untuk pilihan penjualan. |
| KF18 | R18 | Ubiquitous | Sistem harus menyediakan daftar produk surplus pada halaman NGO/publik yang memuat jenis produk, jumlah tersedia, lokasi, dan batas waktu pengambilan. |
| KF19 | R19 | Event-driven | Ketika produk surplus dipublikasikan, sistem harus mengirimkan notifikasi kepada akun NGO terdaftar yang berada dalam radius pemberitahuan dari lokasi produk. |
| KF20 | R20 | Event-driven | Ketika Perwakilan NGO membuka daftar produk surplus, sistem harus menampilkan produk yang diurutkan dari jarak terdekat berdasarkan lokasi pengguna. |
| KF21 | R20 | Ubiquitous | Sistem harus menyediakan fitur pencarian dan penyaringan produk surplus berdasarkan jenis makanan, jarak, dan batas waktu pengambilan. |
| KF22 | R21 | Event-driven | Ketika Perwakilan NGO mengajukan klaim produk surplus, sistem harus memeriksa ketersediaan produk dan menyetujui klaim hanya jika produk masih tersedia. |
| KF23 | R22 | Event-driven | Ketika sistem menyetujui klaim NGO, sistem harus mengubah status produk surplus menjadi "terklaim" sebagai bagian dari proses persetujuan yang sama sehingga klaim lain terhadap produk tersebut tidak dapat disetujui. |
| KF24 | R24 | Event-driven | Ketika Pemilik F&B atau Perwakilan NGO mengonfirmasi pengambilan produk, sistem harus mengubah status pengambilan menjadi "selesai". |
| KF25 | R25 | Ubiquitous | Sistem harus menyediakan dashboard admin untuk melihat, mencari, dan menyaring log aktivitas pengguna. |
| KF26 | R26 | Event-driven | Ketika pengguna melakukan registrasi, login, atau pengajuan klaim, sistem harus mencatat jenis aktivitas, identitas pengguna, dan waktu kejadian dalam log sistem. |
